...
public class Tkwkdcnfxhlrms extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tkwkd_cnfxhlrms);
		...
		button1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, MainActivity.class);
		...
		button2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(LoginActivity.memberPart.equals("true")) {
					Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, Tkwkdcnfxhlrms.class);
					myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(myIntent);
					finish();
				}	
				else if(LoginActivity.memberPart.equals("false")) {
					Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, NewActivitycnfxhlrms.class);
					myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(myIntent);
					finish();
				}
		...
		button3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if(LoginActivity.memberPart.equals("true")) {
					Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, Tkwkdrmqdu.class);
					myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(myIntent);
					finish();
				}
				else if(LoginActivity.memberPart.equals("false")) {
					Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, NewActivityrmqdu.class);
					myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					startActivity(myIntent);
					finish();
				}
		...
		button4.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, NewActivity.class);
				myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(myIntent);
				finish();
			}
		...
		button5.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, NewActivityrntjddnjs.class);
				myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(myIntent);
				finish();
			}
	...
	class HttpTask extends AsyncTask<Void, Void, String>{
        ...
        protected String doInBackground(Void... voids) {
        	...
        	try {        		
        		...
        		for(int i=0; i<jArr.length();i++) {
        			...
        			// 미승인 갯수
            		HttpPost request2 = new HttpPost(LoginActivity.url+"memberunapprove.php");
            		//전달할 인자들
        			...
        			dataArr.add(new MyData( json.getString("id"), json.getString("name"), json2.getString("rows") ));
        ...
        protected void onPostExecute(String value){
            ...
            if(value != null) {
            	...
            	mAdapter = new MyAdapter(Tkwkdcnfxhlrms.this, R.layout.tkwkd_cnfxhlrms_list, dataArr);
	...
	class MyData{
		...
		MyData(String id, String name, String unapprove){
		    this.id = id;
		    this.name = name;
	...
	class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView unapprove = (TextView)convertView.findViewById(R.id.unapprove);
			unapprove.setText("미승인 : " + myDataArr.get(position).unapprove + "건");
			
			member.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					Intent myIntent = new Intent(Tkwkdcnfxhlrms.this, TkwkdInAttend.class);
